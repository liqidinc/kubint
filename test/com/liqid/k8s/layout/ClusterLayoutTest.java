...
public class ClusterLayoutTest {
    ...
    public void createFromInventoryWithUnassignedDevices() {
        ...
        inv.notifyDeviceAddedToGroup(gpu0.getDeviceId(), mainGroupId);
        inv.notifyDeviceAddedToGroup(gpu1.getDeviceId(), mainGroupId);
        inv.notifyDeviceAddedToGroup(gpu2.getDeviceId(), mainGroupId);
        inv.notifyDeviceAddedToGroup(fpga0.getDeviceId(), mainGroupId);
        inv.notifyDeviceAddedToGroup(fpga1.getDeviceId(), mainGroupId);
        inv.notifyDeviceAddedToGroup(fpga2.getDeviceId(), mainGroupId);
    ...
    public void createFromInventoryWithAssignedDevices() {
        ...
        inv.notifyDeviceAddedToGroup(fpga1.getDeviceId(), mainGroupId);
        inv.notifyDeviceAddedToGroup(fpga2.getDeviceId(), mainGroupId);
        inv.notifyDeviceAddedToGroup(fpga3.getDeviceId(), mainGroupId);
        inv.notifyDeviceAddedToGroup(fpga4.getDeviceId(), mainGroupId);
        inv.notifyDeviceAddedToGroup(fpga5.getDeviceId(), mainGroupId);
        inv.notifyDeviceAddedToMachine(gpu0.getDeviceId(), 1);
        inv.notifyDeviceAddedToMachine(gpu1.getDeviceId(), 2);
        inv.notifyDeviceAddedToMachine(fpga0.getDeviceId(), 2);
        inv.notifyDeviceAddedToMachine(fpga1.getDeviceId(), 2);
        inv.notifyDeviceAddedToMachine(fpga2.getDeviceId(), 3);
        inv.notifyDeviceAddedToMachine(fpga3.getDeviceId(), 3);
        inv.notifyDeviceAddedToMachine(fpga4.getDeviceId(), 4);
        inv.notifyDeviceAddedToMachine(fpga5.getDeviceId(), 4);
    ...
    public void flatten_asRequested() {
        ...
        mp1.injectCount(new ResourceModel(LiqidGeneralType.GPU), 3);
        var mp2 = new MachineProfile(mach2);
        mp1.injectCount(new ResourceModel(LiqidGeneralType.GPU), 4);
        mp2.injectCount(new ResourceModel(LiqidGeneralType.GPU, "Liqid", "Gen4"), 2);
        mp2.injectCount(new ResourceModel(LiqidGeneralType.GPU, "Liqid", "Gen5"), 2);
