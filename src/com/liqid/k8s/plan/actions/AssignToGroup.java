...
public class AssignToGroup extends Action {
    ...
    public AssignToGroup setDeviceNames(final Collection<String> list) { _deviceNames = new LinkedList<>(list); return this; }
    ...
    public void perform(
        ...
        try {
            ...
            for (var devName : _deviceNames) {
                ...
                context.getLiqidInventory().notifyDeviceAddedToGroup(devId, groupId);
            }
