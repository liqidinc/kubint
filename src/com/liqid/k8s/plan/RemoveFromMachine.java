...
public class RemoveFromMachine extends Step {
...
//                context._liqidClient.removeDeviceFromMachine(devStat.getDeviceId(), groupId, machineId);
//            }
...
//        return String.format("Remove from Machine %s: %s", _machineName, String.join(", ", _deviceNames));
//    }
}
